...
void malashenko::detail::getInfixData(std::istream& in, Stack< Queue< std::string > >& infixData)
{
  char ch;
...
size_t malashenko::detail::getIndex(const std::string& sign, const List< std::string >& funcs)
{
  size_t ind = 0;
