...
void createNode(std::istream &in, std::ostream &out, RootDB &,
                RLRootNode *layout) {
  if (!layout) {
    out << "Error: no layout initialized\n";
    return;
...
void emptyNode(std::istream &in, std::ostream &out, RootDB &,
               RLRootNode *layout) {
  if (!layout) {
    out << "Error: No layout initialized.\n";
    return;
...
void deleteNode(std::istream &in, std::ostream &out, RootDB &,
                RLRootNode *layout) {
  if (!layout) {
    out << "Error: No layout initialized.\n";
    return;
...
void moveNode(std::istream &in, std::ostream &out, RootDB &,
              RLRootNode *layout) {
  if (!layout) {
    out << "Error: No layout initialized.\n";
    return;
...
void setWidth(std::istream &in, std::ostream &out, RootDB &,
              RLRootNode *layout) {
  if (!layout) {
    out << "Error: No layout initialized.\n";
    return;
...
void setHeight(std::istream &in, std::ostream &out, RootDB &,
               RLRootNode *layout) {
  if (!layout) {
    out << "Error: No layout initialized.\n";
    return;
...
void setSize(std::istream &in, std::ostream &out, RootDB &,
             RLRootNode *layout) {
  if (!layout) {
    out << "Error: No layout initialized.\n";
    return;
