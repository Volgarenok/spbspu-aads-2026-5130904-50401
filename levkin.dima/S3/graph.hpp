...
namespace levkin {
  ...
  struct DB
  {
    ...
    void addEdge(std::string graph_name,
    ...
    void
    showGraphEdges(stuff::Vector< std::pair< std::string, size_t > >& edges,
                   std::ostream& output);
    void showGraphOutbound(std::string graph_name,
                           std::string vertex,
                           std::ostream& output);
    void showGraphInbound(std::string graph_name,
                          std::string vertex,
                          std::ostream& output);
    ...
    void cutGraphEdge(std::string graph_name,
                      ...
                      size_t weight,
                      std::ostream& output);
    void mergeGraphs(std::string new_graph,
